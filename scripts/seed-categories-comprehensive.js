...
const COMPREHENSIVE_CATEGORIES = [
  ...
  { name: 'T-Shirts', parent: 'Shirts', level: 4 },
  { name: 'Dress Shirts', parent: 'Shirts', level: 4 },
  { name: 'Polo Shirts', parent: 'Shirts', level: 4 },
  ...
  { name: 'Blouses', parent: 'Tops', level: 4 },
  { name: 'T-Shirts', parent: 'Tops', level: 4 },
  { name: 'Sweaters', parent: 'Tops', level: 4 },
  { name: 'Bottoms', parent: 'Clothing', level: 3 },
  { name: 'Jeans', parent: 'Bottoms', level: 4 },
