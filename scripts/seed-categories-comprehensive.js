...
const COMPREHENSIVE_CATEGORIES = [
  ...
  // FASHION (Universal - Gender-Neutral, Flattened Structure)
  { name: 'Fashion', parent: null, level: 0 },
  { name: 'Clothing', parent: 'Fashion', level: 1 },
  { name: 'Shirts', parent: 'Clothing', level: 2 },
  { name: 'T-Shirt', parent: 'Shirts', level: 3 },
  { name: 'Button-Down Shirt', parent: 'Shirts', level: 3 },
  { name: 'Polo', parent: 'Shirts', level: 3 },
  { name: 'Blouse', parent: 'Shirts', level: 3 },
  { name: 'Henley', parent: 'Shirts', level: 3 },
  { name: 'Sweaters', parent: 'Clothing', level: 2 },
  { name: 'Pullover Sweater', parent: 'Sweaters', level: 3 },
  { name: 'Cardigan', parent: 'Sweaters', level: 3 },
  { name: 'Hoodie', parent: 'Sweaters', level: 3 },
  { name: 'Sweatshirt', parent: 'Sweaters', level: 3 },
  { name: 'Tanks & Camis', parent: 'Clothing', level: 2 },
  { name: 'Tank Top', parent: 'Tanks & Camis', level: 3 },
  { name: 'Cami', parent: 'Tanks & Camis', level: 3 },
  { name: 'Camisole', parent: 'Tanks & Camis', level: 3 },
  { name: 'Halter Top', parent: 'Tanks & Camis', level: 3 },
  { name: 'Pants', parent: 'Clothing', level: 2 },
  { name: 'Jeans', parent: 'Pants', level: 3 },
  { name: 'Dress Pants', parent: 'Pants', level: 3 },
  { name: 'Chinos', parent: 'Pants', level: 3 },
  { name: 'Leggings', parent: 'Pants', level: 3 },
  { name: 'Joggers', parent: 'Pants', level: 3 },
  { name: 'Shorts', parent: 'Clothing', level: 2 },
  { name: 'Denim Shorts', parent: 'Shorts', level: 3 },
  { name: 'Athletic Shorts', parent: 'Shorts', level: 3 },
  { name: 'Bermuda Shorts', parent: 'Shorts', level: 3 },
  { name: 'Skirts', parent: 'Clothing', level: 2 },
  { name: 'Mini Skirt', parent: 'Skirts', level: 3 },
  { name: 'Midi Skirt', parent: 'Skirts', level: 3 },
  { name: 'Maxi Skirt', parent: 'Skirts', level: 3 },
  { name: 'Pencil Skirt', parent: 'Skirts', level: 3 },
  { name: 'Dresses', parent: 'Clothing', level: 2 },
  { name: 'Maxi Dress', parent: 'Dresses', level: 3 },
  { name: 'Mini Dress', parent: 'Dresses', level: 3 },
  { name: 'Midi Dress', parent: 'Dresses', level: 3 },
  { name: 'Shirt Dress', parent: 'Dresses', level: 3 },
  { name: 'Wrap Dress', parent: 'Dresses', level: 3 },
  ...
  { name: 'Parka', parent: 'Outerwear', level: 3 },
  { name: 'Shoes', parent: 'Clothing', level: 2 },
  { name: 'Sneakers', parent: 'Shoes', level: 3 },
  { name: 'Boots', parent: 'Shoes', level: 3 },
  { name: 'Loafers', parent: 'Shoes', level: 3 },
  { name: 'Dress Shoes', parent: 'Shoes', level: 3 },
  { name: 'Sandals', parent: 'Shoes', level: 3 },
  { name: 'Heels', parent: 'Shoes', level: 3 },
  { name: 'Flats', parent: 'Shoes', level: 3 },
  { name: 'Slippers', parent: 'Shoes', level: 3 },
  { name: 'Hats', parent: 'Clothing', level: 2 },
  { name: 'Baseball Cap', parent: 'Hats', level: 3 },
  { name: 'Beanie', parent: 'Hats', level: 3 },
  { name: 'Fedora', parent: 'Hats', level: 3 },
  { name: 'Sun Hat', parent: 'Hats', level: 3 },
  { name: 'Socks', parent: 'Clothing', level: 2 },
  { name: 'Ankle Socks', parent: 'Socks', level: 3 },
  { name: 'Crew Socks', parent: 'Socks', level: 3 },
  { name: 'Knee-High Socks', parent: 'Socks', level: 3 },
