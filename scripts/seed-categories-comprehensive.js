...
const COMPREHENSIVE_CATEGORIES = [
  ...
  { name: 'Rug', parent: 'Home Decor', level: 2 },
  { name: 'Lighting', parent: 'Home Decor', level: 2 },
  { name: 'Lamp', parent: 'Lighting', level: 3 },
  { name: 'Chandelier', parent: 'Lighting', level: 3 },
  { name: 'Window Treatment', parent: 'Home Decor', level: 2 },
  { name: 'Panel', parent: 'Window Treatment', level: 3 },
  { name: 'Curtain', parent: 'Window Treatment', level: 3 },
  { name: 'Drape', parent: 'Window Treatment', level: 3 },
  { name: 'Blind', parent: 'Window Treatment', level: 3 },
  { name: 'Shade', parent: 'Window Treatment', level: 3 },
  ...
  { name: 'Shirt', parent: 'Clothing', level: 3 },
  { name: 'T-Shirt', parent: 'Shirt', level: 4 },
  { name: 'Dress Shirt', parent: 'Shirt', level: 4 },
  { name: 'Polo Shirt', parent: 'Shirt', level: 4 },
  { name: 'Bottom', parent: 'Clothing', level: 3 },
  { name: 'Jeans', parent: 'Bottom', level: 4 },
  { name: 'Pants', parent: 'Bottom', level: 4 },
  { name: 'Shorts', parent: 'Bottom', level: 4 },
  { name: 'Jacket', parent: 'Clothing', level: 3 },
  { name: 'Footwear', parent: 'Men', level: 2 },
  { name: 'Sneaker', parent: 'Footwear', level: 3 },
  { name: 'Boot', parent: 'Footwear', level: 3 },
  { name: 'Loafer', parent: 'Footwear', level: 3 },
  { name: 'Slipper', parent: 'Footwear', level: 3 },
  { name: 'Sandal', parent: 'Footwear', level: 3 },
  { name: 'Dress Shoe', parent: 'Footwear', level: 3 },
  { name: 'Accessory', parent: 'Men', level: 2 },
  { name: 'Watch', parent: 'Accessory', level: 3 },
  { name: 'Belt', parent: 'Accessory', level: 3 },
  { name: 'Women', parent: 'Fashion', level: 1 },
  { name: 'Clothing', parent: 'Women', level: 2 },
  { name: 'Dress', parent: 'Clothing', level: 3 },
  { name: 'Top', parent: 'Clothing', level: 3 },
  { name: 'Blouse', parent: 'Top', level: 4 },
  { name: 'T-Shirt', parent: 'Top', level: 4 },
  { name: 'Sweater', parent: 'Top', level: 4 },
  { name: 'Bottom', parent: 'Clothing', level: 3 },
  { name: 'Jeans', parent: 'Bottom', level: 4 },
  { name: 'Skirt', parent: 'Bottom', level: 4 },
  { name: 'Pants', parent: 'Bottom', level: 4 },
  { name: 'Footwear', parent: 'Women', level: 2 },
  { name: 'Heel', parent: 'Footwear', level: 3 },
  { name: 'Flat', parent: 'Footwear', level: 3 },
  { name: 'Sneaker', parent: 'Footwear', level: 3 },
  { name: 'Accessory', parent: 'Women', level: 2 },
  { name: 'Handbag', parent: 'Accessory', level: 3 },
  { name: 'Jewelry', parent: 'Accessory', level: 3 },
  ...
  { name: 'Diaper', parent: 'Baby Care', level: 2 },
  { name: 'Baby Food', parent: 'Baby Care', level: 2 },
  { name: 'Wipe', parent: 'Baby Care', level: 2 },
