...
const COMPREHENSIVE_CATEGORIES = [
  ...
  { name: 'Shirt', parent: 'Tops', level: 4 },
  { name: 'T-Shirt', parent: 'Tops', level: 4 },
  { name: 'Sweater', parent: 'Tops', level: 4 },
  { name: 'Hoodie', parent: 'Tops', level: 4 },
  { name: 'Bottoms', parent: 'Clothing', level: 3 },
  { name: 'Jeans', parent: 'Bottoms', level: 4 },
  { name: 'Pants', parent: 'Bottoms', level: 4 },
  { name: 'Shorts', parent: 'Bottoms', level: 4 },
  { name: 'Outerwear', parent: 'Clothing', level: 3 },
  { name: 'Jacket', parent: 'Outerwear', level: 4 },
  { name: 'Coat', parent: 'Outerwear', level: 4 },
  ...
  { name: 'Scarves', parent: 'Accessories', level: 3 },
